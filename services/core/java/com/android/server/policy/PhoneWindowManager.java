...
import org.lineageos.internal.util.LOSActionUtils;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    Runnable mCloseApp = new Runnable() {
        public void run() {
            ...
            if (LOSActionUtils.killForegroundApp(mContext, mCurrentUserId)) {
                performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
    ...
    private void performKeyAction(Action action, KeyEvent event) {
        switch (action) {
            ...
            case SLEEP:
                ...
                break;
            case LAST_APP:
                LOSActionUtils.switchToLastApp(mContext, mCurrentUserId);
                break;
            case SPLIT_SCREEN:
                toggleSplitScreen();
                break;
