...
public class CallbackHandlerTest extends SysuiTestCase {
    ...
    public void testSignalCallback_setMobileDataIndicators() {
        ...
        boolean isMobileIms = true;
        mHandler.setMobileDataIndicators(status, qs, type, qsType, in, out, typeDescription,
                typeDescriptionHtml, description, wide, subId, roaming, isMobileIms);
        waitForCallbacks();
        ...
        Mockito.verify(mSignalCallback).setMobileDataIndicators(statusArg.capture(),
                ...
                descArg.capture(), wideArg.capture(), subIdArg.capture(), eq(roaming), eq(isMobileIms));
        assertEquals(status, statusArg.getValue());
        assertEquals(qs, qsArg.getValue());
