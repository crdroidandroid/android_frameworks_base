...
public class QSClockLeft extends Clock {

    private boolean mClockVisibleByPolicy = true;
    private boolean mClockVisibleByUser = true;

    public QSClockLeft(Context context) {
        this(context, null);
    }

    public QSClockLeft(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QSClockLeft(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void updateClockVisibility() {
        boolean visible = mQSClockStyle == STYLE_CLOCK_LEFT
