...
public class CrDroidKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(CrDroidKeyguardSliceProvider keyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            CrDroidKeyguardSliceProvider keyguardSliceProvider;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProvider = (CrDroidKeyguardSliceProvider) mProviderReference.get();
            }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("CrDroidKeyguardSliceProvider#onBindSlice");
        Slice slice;
