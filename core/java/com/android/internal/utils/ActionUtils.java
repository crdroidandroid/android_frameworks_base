...
public final class ActionUtils {
    ...
    public static final String CLASS_NAME_ICON_PICKER_GRID_ACTIVITY = "com.crdroid.settings.fragments.navigation.smartnav.IconPackGridActivity";
    public static final String CLASS_NAME_ICON_PICKER_ACTIVITY = "com.crdroid.settings.fragments.navigation.smartnav.IconPickerActivity";
    public static final String CLASS_NAME_ACTION_EDIT = "com.crdroid.settings.fragments.navigation.smartnav.ActionPickerDialogActivity";
    public static final String CLASS_NAME_GALLERY_PICKER = "com.crdroid.settings.fragments.navigation.smartnav.IconPickerGallery";
