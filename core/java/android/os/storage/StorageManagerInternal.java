...
public abstract class StorageManagerInternal {
     ...
     */
    public abstract void setResetListener(ResetListener listener);

    /**
     * A method that should be triggered by StorageManagerService when reset happens.
     *
     * @param vold The binder object to vold.
     */
    public abstract void onReset(IVold vold) throws Exception;
}
